...
const messages = {
  zh: {
    ...
    summaryBubbleLabel: '历史摘要',
    summarizingBubble: '正在生成摘要…',
    summaryBubbleUpdating: '正在更新摘要…',
    typing: '助手正在输入...',
  ...
  en: {
    ...
    summaryBubbleLabel: 'Past summary',
    summarizingBubble: 'Generating summary…',
    summaryBubbleUpdating: 'Updating summary…',
